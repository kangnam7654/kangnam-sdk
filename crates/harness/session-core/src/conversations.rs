//! Legacy rusqlite free-function API — kept for session-rpc / session-server
...
// path `kangnam_harness_session_core::conversations::Conversation` continues to resolve.
