...
//!
//! ```no_run
//! use kangnam_design_export_pptx::{PptxTemplate, ImageMime, FontVariant};
//! use std::path::Path;
//!
...
//! let bytes = t.pack()?;
//! # Ok::<(), kangnam_design_export_pptx::PptxWriteError>(())
//! ```
...
impl PptxTemplate {
    ...
    /// # Example
    /// ```no_run
    /// use kangnam_design_export_pptx::{PptxTemplate, FontVariant};
    /// # fn main() -> kangnam_design_export_pptx::Result<()> {
